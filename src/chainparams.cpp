...
// Copyright (c) 2014-2017 The chickendinner Core developers
...
{
    const char* pszTimestamp = "ChickenDinner, Winner Winner Chicken Dinner";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 60; // chickendinner: 1 day
        consensus.nPowTargetSpacing = 120 ; // chickendinner: 2.5 minutes
        ...
        vSeeds.push_back(CDNSSeedData("N1", "node1.chickendinnerpay.org"));
        vSeeds.push_back(CDNSSeedData("N2", "node2.chickendinnerpay.org"));
        vSeeds.push_back(CDNSSeedData("N3", "node3.chickendinnerpay.org"));

        // chickendinner addresses start with 'P'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,55);
        // chickendinner script addresses start with '3'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,5);
        // chickendinner private keys start with '3' or 'p'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,60);
        // chickendinner BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // chickendinner BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // chickendinner BIP44 coin type is '5'
        nExtCoinType = 5;
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffff000000000000000000000000000000000000000000000000000000");
        consensus.nPowTargetTimespan = 120; // chickendinner: 1 day
        consensus.nPowTargetSpacing = 1; // chickendinner: 2.5 minutes
        ...
        // Testnet chickendinner addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Testnet chickendinner script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet chickendinner BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet chickendinner BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet chickendinner BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    CRegTestParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // chickendinner: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // chickendinner: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
      ...
      genesis = CreateGenesisBlock(1513831322, 887612, 0x1e0ffff0, 1, 50 * COIN);
        ...
        // Regtest chickendinner addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest chickendinner script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest chickendinner BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest chickendinner BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest chickendinner BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
   }
};
